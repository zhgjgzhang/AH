...
Page({
  ...
  turnToVideoAssess : function(event) {
    app.turnToPage('/video/pages/videoAssess/videoAssess?detail=' + this.data.videoId );
  },
  // 添加、取消收藏
  ...
  turnToVideoDetail : function(event) {
    ...
    app.turnToPage('/video/pages/videoDetail/videoDetail?detail=' + id);
  },
  // 获取弹幕
  danmuId : [],
  getDanmu : function() {
  ...
  onShareAppMessage : function() {
    ...
    return {
      ...
      path: '/video/pages/videoDetail/videoDetail?detail=' + id,
      success: function(res) {
        // 转发成功
      },
      fail: function(res) {
