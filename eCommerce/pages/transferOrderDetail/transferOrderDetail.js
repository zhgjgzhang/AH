    ...
    app.getOrderDetail({
      ...
      success: function (res) {
        ...
        if(orderInfo.selected_combination_benefit){                
          ...
          combinationBenefit.vip_benefit && combinationBenefit.vip_benefit.discount_price ? combinationBenefit.vip_benefit.discount_price = (+combinationBenefit.vip_benefit.discount_price).toFixed(2) : '';
