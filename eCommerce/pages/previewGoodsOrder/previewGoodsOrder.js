  ...
  getCalculationInfo: function(){
    ...
    app.sendRequest({
      ...
      success: function(res){
        ...
        let group_buy_discount_price = String(info.original_price - info.group_buy_discount_price);
        if(group_buy_discount_price.split('.')[1]){
          group_buy_discount_price.split('.')[1].length > 2;
          group_buy_discount_price = Number(group_buy_discount_price).toFixed(2);
        }
        _this.setData({
          ...
          group_buy_discount_price: Number(group_buy_discount_price),
